...
export const slamBeforeDuration: number = 1000;
...
export const slamAfterDuration: number = 500;
...
export const playerSlammedStunDuration: number = 500;
...
export const enemySlamDamage: number = 2;
export const enemySpawnTime: number = 9500;
...
export const shootingEnemiesStartAt: number = 5000;
